...
def main():
    ...
    xt = tf.nn.relu(tf.nn.convolution(input=xt, filter=W[0], strides=[1, 1], padding='SAME', dilation_rate=[1, 1]) + b[0])
    xt = tf.nn.max_pool(xt, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding='SAME')

    xt = tf.nn.relu(tf.nn.convolution(input=xt, filter=W[1], strides=[1, 1], padding='SAME', dilation_rate=[1, 1]) + b[1])
    xt = tf.nn.max_pool(xt, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding='SAME')
